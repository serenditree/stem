...
export _ST_POD_TIMEOUT=${_ST_POD_TIMEOUT:-5}
...
export _ST_VERSION_KUBERNETES=1.33.2
export _ST_VERSION_JAVA=21
export _ST_VERSION_NODE=24.x
export _ST_VERSION_GO=1.24
export _ST_VERSION_K6=1.1.0
export _ST_VERSION_TILESERVER=5.3.1
export _ST_VERSION_ANGULAR=20
...
export _ST_VERSION_FIXED_HELM='tekton-pipeline' # chart[|chart]
########################################################################################################################
# BUILD
########################################################################################################################
...
export _ST_FROM_ROOT_SEED_DASH=docker.io/bitnami/opensearch-dashboards:${_ST_VERSION_OPENSEARCH}
