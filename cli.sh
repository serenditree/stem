...
{
    local first_option all_short_options='aDEhkloPTwvyis'
    first_option="${1:0:1}"
...
print_help()
{
    printf 'Usage: %s [-a|--all] [--compose] [--delete] [-D|--dryrun] [-E|--expose] [-h|--help] [--init] [--insert] [--integration] [-k|--kubernetes] [-l|--local] [--open] [-o|--openshift] [-P|--prod] [--reset] [--setup] [-T|--test] [--upgrade] [-w|--wait] [-v|--verbose] [-y|--yes] [-i|--issuer_override] [-s|--scale <arg>] [--resume <arg>] [--] <command> ... \n' " sc" && echo
    ...
    printf '\t%-20s%s\n' "-i, --issuer_override:" "Set cert-issuer to prod when stage is not prod and vice versa."
    ...
    do
        ...
        case "$_key" in
            ...
            -y*)
                ...
                ;;
            -i|--no-issuer_override|--issuer_override)
                _arg_issuer_override="on"
                test "${1:0:5}" = "--no-" && _arg_issuer_override="off"
                ;;
            -i*)
                _arg_issuer_override="on"
                _next="${_key##-i}"
