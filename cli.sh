...
{
    local first_option all_short_options='aDEhkloPTwvy'
    first_option="${1:0:1}"
...
print_help()
{
    printf 'Usage: %s [-a|--all] [--compose] [--delete] [-D|--dryrun] [-E|--expose] [-h|--help] [--init] [--insert] [--integration] [-k|--kubernetes] [-l|--local] [--open] [-o|--openshift] [-P|--prod] [--reset] [--setup] [-T|--test] [--upgrade] [-w|--watch] [-v|--verbose] [-y|--yes] [--issuer <arg>] [--resume <arg>] [--] <command> ... \n' " sc" && echo
